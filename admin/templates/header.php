...
            </a>
          ...
          <?php $url = "http://".$_SERVER['HTTP_HOST']."/admincancun" ?>
            ...
            <!-- Calendario -->
            <li class="menu-item">
              <a href="../admin/html/calendario.html" class="menu-link">
            ...
            <!-- Lugares -->
            <li class="menu-item">
              <a href="../admin/html/lugares.html" class="menu-link">
            ...
            <!-- Zonas -->
            <li class="menu-item">
              <a href="../admin/html/zonas.html" class="menu-link">
            ...
            <!-- Paquetes -->
            <li class="menu-item">
              <a href="../admin/html/paquetes.html" class="menu-link">
