            ...
            <a href="admin.php" class="app-brand-link">
              <span class="app-brand-logo demo">
                <svg
                  ...
                  viewBox="0 0 25 42"
                  version="1.1"
                  xmlns="assets/img/cancun-cab-transportation-logo.png"
                  xmlns:xlink="assets/img/cancun-cab-transportation-logo.png"
                >
                  <defs>
                    <path
              ...
              <span class="demo menu-text fw-bolder ms-2">ADMIN CANCUN CAB</span>
            </a>
